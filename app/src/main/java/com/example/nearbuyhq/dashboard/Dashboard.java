...
import com.example.nearbuyhq.discounts.DealsList;
import com.example.nearbuyhq.discounts.Promotions;
...
public class Dashboard extends AppCompatActivity {
    ...
    private void setupQuickActions() {
        ...
        btnDiscounts.setOnClickListener(v -> {
            Intent intent = new Intent(Dashboard.this, DiscountsActivity.class);
            startActivity(intent);
        });
